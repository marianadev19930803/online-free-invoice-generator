  ...
  return (<>
    ...
    <div className="bg-[#f7f7f7] flex justify-center items-center overflow-x-hidden">
      <div className="border-l border-r max-w-4xl w-full mx-auto border-dashed h-full flex justify-center flex-col border-gray-300">
        ...
        {/* Left Sidebar Banner - Desktop (300x600) */}
        <div className="hidden lg:block fixed left-4 top-1/2 transform -translate-y-1/2">
          <div className="w-[300px] h-[600px] bg-gray-100 flex items-center justify-center rounded-lg">
            <div data-banner-id="6101630" className="w-full h-full"></div>
          </div>
        </div>

        {/* Right Sidebar Banner - Desktop (300x600) */}
        ...
        {/* Middle Ad Banner 1 - Desktop (728x90) */}
        ...
        {/* Bottom Ad Banner - Desktop (728x90) */}
